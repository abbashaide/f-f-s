					  ...
					  <div className="measure center">
					    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
					      ...
					      <div className="pa4">
					        ...
					        <span className='w-20 mr3 f3'><FontAwesomeIcon icon={faUserTag} /></span>
					        <input className="pa2 input-reset bn bg-transparent hover-bg-black hover-white w-80" type="text" name="name"  id="name" />
					      	</label>
					      </div> 
					      <div className="mt3 bb b--black-10">
